...
/**
* This script handles the login in procedure by setting all session variables responding to the post method with
* getSession.php which returns the session variables.
* 
