...
* 
* The requested post method takes four variables with make up the 
* post it also handles all the validation for the html form while 
* resposing with error messages for those forms entered incorrectly.
*
* @package      Default
* @subpackage   Post
...
/**
* This function takes in a string variable which is a username and returns the value of the greatest userpostid so that all the posts for one user have a unique identifier.
...
/**
* This function pushes the new post infomation onto the array of the post.json file then overrides file with the new post data array.
*
