...
/**
* This script updates a given post's content with the one changed by the user, also responds to the request with a message for the user.
*
*
* @package      Default
* @subpackage   Post
...
/**
* This function finds the post that is in question and changes the content to the one passed by the post method, then overrides the post.json file with the new changed one.
*
* @param string $c new content input
* @param string $username username of the post trying to be updated
* @param int $userpostid userpostif of the post trying to be updated
*/
